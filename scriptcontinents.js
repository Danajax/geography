...
let listCountry = ['africa', 'antarctica', 'asia', 'europe', 'northamerica', 'oceania', 'southamerica']; // lengden er 37 
...
function writeimg(){
		...
		document.getElementById("bildeavland").innerHTML = `<img src="./Bilder/continents/${listCountry[random027]}.png">`;
	}
